...
import { CheckCircle2, Loader2, ArrowRight, Calendar, Ticket } from "lucide-react";
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <Link href="/" className="bg-white text-slate-950 px-8 py-3 rounded-xl font-bold">
                    Back to Home
                </Link>
            </div>
        );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
                ...
                >
                    ...
                    <div className="text-left">
                        <p className="text-xs text-gray-500 uppercase font-bold">View Tickets</p>
                        <p className="font-bold group-hover:text-purple-400">Go to Dashboard</p>
                    </div>
                ...
                >
                    ...
                    <div className="text-left">
                        <p className="text-xs text-gray-500 uppercase font-bold">More Events</p>
                        <p className="font-bold group-hover:text-pink-400">Browse Calendar</p>
                    </div>
                    <ArrowRight className="w-4 h-4 ml-auto text-gray-600 group-hover:text-white" />
                </Link>
            </div>
